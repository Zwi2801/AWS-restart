...
This lab enabled me to get an understanding of the purpose of a VPCs and the process they follow when isolating network resources and setting up internet gateways to provide external connectivity when necessary. Additionally, I learned how network segmentation helps improve security and easier management of traffic flow between subnets for example. I was able to clearly define multiple subnets within the VPC and configured routing tables to allow and restrict traffic between subnets, which came with its own set of difficulties because a good understanding of how traffic flows is required. I then had to invest time into researching about traffic inflows even though it was quite challenging .I wasn’t entirely sure of how to go about researching about validating and verifying the VPC and subnet configurations by checking IP ranges and routes but I read and watched a few online videos and got a good understanding. 
