...
This lab enabled me to expand my knowledge and get practical experience on how Python works. After successfully connecting to the instance, I wrote and tested a Python script that identified all prime numbers between 1 and 250 and saved the results to a text file. This lab helped bridge infrastructure skills (SSH and EC2 access) with basic scripting and automation in a cloud environment.
